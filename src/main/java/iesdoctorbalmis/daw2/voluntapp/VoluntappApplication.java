...
public class VoluntappApplication {
	...
	// @Bean
	// CommandLineRunner init(UsuariosService usuariosService, InstitucionesService  institucionesService,EventosService eventosService, UbicacionService ubicacionService) {
	// 	return (args) -> {

	// 		Instituciones instituciones = new Instituciones(null, "Unicef@example.com", "12345678A", "Unicef ORG", "616 616 616", "Manolito", "Unicef", "123", "/assets/imagen", null);
	...
	// 		Ubicacion ubicacion = new Ubicacion(null, "Calle De San Olegario, Madrid", -3.7602838, 40.3699524);
	// 		ubicacionService.guardar(ubicacion);

	// 		Ubicacion ubicacion2 = new Ubicacion(null, "N-340, Pk 131, Alcoi, Alicante", -0.47140612489073314, 38.683488155501855);
	// 		ubicacionService.guardar(ubicacion2);

	// 		Ubicacion ubicacion3 = new Ubicacion(null, "Playa Postiguet, Alicante", -0.47876710565513714, 38.3444807533824 );
	// 		ubicacionService.guardar(ubicacion3);

	// 		Ubicacion ubicacion4 = new Ubicacion(null, "C. Escultor Bañuls 7, Alicante", -0.4912633978169558, 38.35726809850449);
	// 		ubicacionService.guardar(ubicacion4);

	// 		Ubicacion ubicacion5 = new Ubicacion(null, "Pintor Baeza 11, Alicante", -0.48590116945300316, 38.36322105571466);
	...
	// 		Usuarios usuario = new Usuarios(null, "Manuel", "manuel@example.com", "Rodriguez Martinez", "12345678A", "Calle Alfonso el sabio 1", "123", "/assets/imagen","612 612 612", "Usuario", null);
	// 		usuariosService.guardar(usuario);
	// 		listaUsuarios.add(usuario);

	// 		Usuarios usuario2 = new Usuarios(null, "Jose Miguel","jose@example.com", "Muñoz Vazquez", "21436587B", "Calle Teulada 10", "123", "/assets/imagen", "613 613 613", "Usuario", null);
	// 		usuariosService.guardar(usuario2);
	// 		listaUsuarios.add(usuario2);

	// 		Usuarios usuario3 = new Usuarios(null, "Administrador", "admin@example.com", "Admin", "Inventado", "", "123", "/assets/imagen","", "Admin", null);
	...
	// 		listaEventosUsuarios2.add(eventos1);
	...
	// 		listaEventosUsuarios2.add(eventos6);	
	// 	};
	//  }
}
