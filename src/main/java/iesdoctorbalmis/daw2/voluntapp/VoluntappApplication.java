...
public class VoluntappApplication {
	...
	// 	return (args) -> {
			...
			// 		"/assets/imagen","/assets/images/bannervoluntario1.png", "612 612 612", "Usuario", listaEventosUsuarios);
			...
			// 		"/assets/images/bannervoluntario2.jpg",
			...
			// 		"Admin", "Inventado", "", "123", "/assets/imagen"
			// 		,"/assets/images/banneradmin.jpg", "", "Admin", listaEventosUsuarios3);
