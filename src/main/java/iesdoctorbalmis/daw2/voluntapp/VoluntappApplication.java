...
public class VoluntappApplication {
	...
	// 				"https://voluntapp.blob.core.windows.net/images/perfiles/default.webp","https://voluntapp.blob.core.windows.net/images/banners/default.webp", "612 612 612", "Usuario", listaEventosUsuarios);
	// 		usuariosService.guardar(usuario);
	// 		listaUsuarios.add(usuario);

	// 		Usuarios usuario2 = new Usuarios(null, "Jose Miguel", "jose@example.com",
	// 				"Muñoz Vazquez", "21436587B", "Calle Teulada 10", "123", "https://voluntapp.blob.core.windows.net/images/perfiles/default.webp", 
	...
	// 				"Admin", "Inventado", "", "123", "https://voluntapp.blob.core.windows.net/images/perfiles/default.webp"
	// 				,"https://voluntapp.blob.core.windows.net/images/banners/default.webp", "", "Admin", listaEventosUsuarios3);
